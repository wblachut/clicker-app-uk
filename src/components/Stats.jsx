  ...
  return (
    <React.Fragment>
      <section className="stats left">
        ...
        {props.treesPerSec !== 0 && <p className="stats-counter valign-wrapper">
          <i className="material-icons white-text stats-icon">face</i> {props.treesPerSec}
        </p>}
        {props.itemsCount !== 0 && <p className="stats-counter valign-wrapper">
        <img className="nav-icon" alt="shovel-icon" src={shovel}/> {props.itemsCount}
        </p>}
        {props.achieveCount !== 0 && <p className="stats-counter valign-wrapper">
          <FontAwesomeIcon icon={faTrophy} className="stats-icon" />
          {props.achieveCount}
        </p>}
        {props.goldTotal !== 0 && <p className="stats-counter valign-wrapper">
